...
The 1st Brillouin zone is between is inside $k = \pm 7.99nm^{-1}$
As the graph shows for little values for $k$ the linear relation between
$\omega$ and $k$ is a good approximation.
