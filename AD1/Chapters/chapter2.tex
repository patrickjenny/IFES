...
lead to systematic extinctions.
...
Planes where we obtain the first 3 difraction maximums are following: 
...
These are the Bragg angles for which maximums appear in an X-ray diffraction pattern.
